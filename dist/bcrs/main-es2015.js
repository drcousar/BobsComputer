...
let HomeComponent = class HomeComponent {
    constructor(http, cookieservice, fb, dialog, router) {
        this.http = http;
        this.cookieservice = cookieservice;
        this.fb = fb;
        this.dialog = dialog;
    ...
    submit(form) {
        ...
        console.log(invoice);
        const dialogRef = this.dialog.open(_invoice_invoice_component__WEBPACK_IMPORTED_MODULE_7__["InvoiceComponent"], {
            data: {
                invoice: invoice
            },
            disableClose: true,
...
let RoleManagementComponent = class RoleManagementComponent {
    ...
    delete(_id, name) {
        const dialogRef = this.dialog.open(_role_delete_dialog_role_delete_dialog_component__WEBPACK_IMPORTED_MODULE_3__["RoleDeleteDialogComponent"], {
            data: {
                _id: _id,
                name: name
            },
...
let ServiceGraphComponent = class ServiceGraphComponent {
    constructor(http) {
        this.http = http;
        this.itemCount = [];
        this.labels = [];
...
ServiceGraphComponent.ctorParameters = () => [
    { type: _angular_common_http__WEBPACK_IMPORTED_MODULE_2__["HttpClient"] }
];
...
SignupDialogComponent.ctorParameters = () => [
    { type: _angular_material_dialog__WEBPACK_IMPORTED_MODULE_2__["MatDialogRef"] },
    { type: undefined, decorators: [{ type: _angular_core__WEBPACK_IMPORTED_MODULE_1__["Inject"], args: [_angular_material_dialog__WEBPACK_IMPORTED_MODULE_2__["MAT_DIALOG_DATA"],] }] },
    { type: _angular_router__WEBPACK_IMPORTED_MODULE_3__["Router"] }
];
...
let SignupComponent = class SignupComponent {
    ...
    */
     ...
     */
    passMessage(message) {
        const dialogRef = this.dialog.open(_signup_dialog_signup_dialog_component__WEBPACK_IMPORTED_MODULE_5__["SignupDialogComponent"], {
            data: {
                message: message
            },
            disableClose: true,
